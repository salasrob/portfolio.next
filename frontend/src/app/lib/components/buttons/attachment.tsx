...
const Attachment: React.FC<LinkProps> = ({ title, href, download }) => {
    return (
        <li className="mr-4">
            <a className="relative mt-2 inline-flex items-center text-sm font-medium text-stone-300 hover:text-od-400 focus-visible:text-od-400" href={href} download={download}>
